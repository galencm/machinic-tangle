...
name="machinic_tangle",
    ...
    data_files = [("", ["LICENSE.txt", "./machinic_tangle/iot_homie_button.gsl", "./machinic_tangle/model_button.xml","./machinic_tangle/mosquitto.conf","./machinic_tangle/homie_associate.json"])],
    url="",
    packages=find_packages(),
    install_requires=['kivy', 'ma_cli', 'lings', 'keli', 'lxml', 'jinja2', 'netifaces'],
